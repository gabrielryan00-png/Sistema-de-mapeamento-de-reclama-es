// design-canvas.jsx – Wrapper de canvas estilo Figma (pan/zoom).
// Usado apenas como container de exportação; no modo standalone o dashboard
// é renderizado diretamente sem este wrapper.
  ...
  return (
    <div ref={vpRef} className="design-canvas" style={{
      ...
      <div ref={worldRef} style={{
        ...
        <div style={{ position:'absolute', inset:-6000, backgroundImage:gridSvg,
  ...
  return (
    <div ref={ref} data-dc-slot={id} style={{ position:'relative', flexShrink:0 }}>
      <div className="dc-labelrow" style={{ position:'absolute', bottom:'100%', left:-4, marginBottom:4, color:DC.label }}>
        <div className="dc-grip" onPointerDown={onGripDown} title="Arrastar para reordenar">
        ...
        <div className="dc-labeltext" onClick={onFocus} title="Clique para focar">
          <DCEditable value={label} onChange={onRename} onClick={e => e.stopPropagation()}
            style={{ fontSize:15, fontWeight:500, color:DC.label, lineHeight:1 }}/>
        </div>
      </div>
      <button className="dc-expand" onClick={onFocus} onPointerDown={e => e.stopPropagation()} title="Focar">
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round">
          <path d="M7 1h4v4M5 11H1V7M11 1L7.5 4.5M1 11l3.5-3.5"/>
        </svg>
      </button>
      <div className="dc-card" style={{ borderRadius:2, boxShadow:'0 1px 3px rgba(0,0,0,.08),0 4px 16px rgba(0,0,0,.06)',
...
function DCFocusOverlay({ entry, sectionMeta, sectionOrder }) {
  ...
  const Arrow = ({ dir, onClick: oc }) => (
    <button onClick={e => { e.stopPropagation(); oc(); }}
  ...
  return ReactDOM.createPortal(
    <div onClick={() => ctx.setFocus(null)} onWheel={e => e.preventDefault()}
      ...
      <div onClick={e => e.stopPropagation()} style={{ position:'absolute', top:0, left:0, right:0, height:72,
        ...
        <div style={{ position:'relative' }}>
          ...
          {ddOpen && (
            <div style={{ position:'absolute', top:'100%', left:0, marginTop:4, background:'#2a251f',
              borderRadius:8, boxShadow:'0 8px 32px rgba(0,0,0,.4)', padding:4, minWidth:200, zIndex:10 }}>
      ...
      <div style={{ position:'absolute', top:64, bottom:56, left:100, right:100,
        ...
        <div onClick={e => e.stopPropagation()} style={{ width:width*scale, height:height*scale, position:'relative' }}>
          <div style={{ width, height, transform:`scale(${scale})`, transformOrigin:'top left',
            background:'#fff', borderRadius:2, overflow:'hidden', boxShadow:'0 20px 80px rgba(0,0,0,.4)' }}>
